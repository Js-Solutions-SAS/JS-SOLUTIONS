...
export default function AdminLayout({ children }: AdminLayoutProps) {
  const navigation = [
    ...
    { name: "Operaciones & SOPs", href: "/admin/operaciones", icon: BookOpen },
    { name: "Configuración", href: "/admin/configuracion", icon: Settings },
  ];

  return (
    <div className="min-h-screen bg-[#FAFAFA] flex flex-col md:flex-row font-[family-name:var(--font-geist-sans)] selection:bg-neutral-900 selection:text-white">
      {/* Sidebar Desktop */}
          ...
          <button className="w-full flex items-center justify-between p-3 rounded-xl hover:bg-neutral-50 transition-colors border border-transparent hover:border-neutral-100">
            <div className="flex items-center gap-3">
              ...
              <div className="text-left flex flex-col">
                ...
                <span className="text-xs text-neutral-500">Panel Interno</span>
              </div>
            </div>
