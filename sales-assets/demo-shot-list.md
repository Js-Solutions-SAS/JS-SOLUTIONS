...
| Orden | Pantalla | Que mostrar | Mensaje comercial |
| --- | --- | --- | --- |
| 1 | Landing home | Hero, CTA principal, autoridad tecnica | "No vendemos solo web; vendemos un flujo comercial completo." |
| 2 | `/pymes` | Demo de WhatsApp y beneficios | "El lead entra por el canal que la PyME ya usa." |
| 3 | `/cotizador` | Preguntas, preview y envio | "Convertimos interes en alcance accionable." |
| 4 | Admin dashboard | Navegacion de modulos | "El equipo opera ventas y entrega desde un cockpit." |
| 5 | Admin cotizaciones | Listado o flujo de cotizacion | "Cada oportunidad queda trazable." |
| 6 | Admin entregas/cambios/SLA | Modulos operativos | "La promesa comercial se conecta con ejecucion." |
| 7 | Portal dashboard | Estado del proyecto | "El cliente sabe en que va el trabajo." |
...
- Clip 1: "Una web sola no resuelve ventas."
- Clip 2: "WhatsApp necesita seguimiento, no solo respuesta."
- Clip 3: "n8n no debe ser tu base de datos."
- Clip 4: "Un portal reduce mensajes repetidos."
- Clip 5: "Tu operacion comercial debe verse en un cockpit."
