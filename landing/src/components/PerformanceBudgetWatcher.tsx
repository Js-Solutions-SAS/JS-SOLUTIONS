...
export default function PerformanceBudgetWatcher() {
  ...
  useEffect(() => {
    ...
    document.addEventListener("astro:after-swap", updateRoute as EventListener);

    return () => {
      window.removeEventListener("popstate", updateRoute);
      document.removeEventListener("astro:after-swap", updateRoute as EventListener);
    };
  }, []);
  ...
  useEffect(() => {
    const reportMetric = (metric: Metric) => {
      ...
      fetch("/api/public/performance-alerts", {
        method: "POST",
        headers: {
